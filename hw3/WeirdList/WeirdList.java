...
public class WeirdList {
    ...
    public static final WeirdList EMPTY = new WeirdListChild();
    ...
    public String toString() {
        return " " + this.HEAD + TAIL.toString();
    }
    ...
    private static class WeirdListChild extends WeirdList {
        public WeirdListChild() {
            super(0, null);
        }
        public int length() {
            return 0;
